...
function Footer() {
  return (
    <div className="w-full h-90 rounded-lg flex justify-center py-5 items-center bg-secondary-bg flex-wrap text-main-text ">
      <div className="w-[90%] rounded-lg flex flex-col">
        <div className="flex justify-around mx-auto space-x-2">
          <div className="flex flex-col text-left px-3 flex-wrap flex-1">
            <div className="text-left font-['Saira_Stencil'] font-semibold md:text-xl text-lg text-black dark:text-white">
              preet<span className="text-orange-500">ify</span>
            </div>

            <p className="text-left pb-2 pt-1 text-main-text text-sm w-3/4">
          ...
          <div className="flex flex-col text-left md:px-3 flex-wrap flex-1  md:text-xl text-lg">
            <h3 className="text-gray-900 dark:text-white pb-1 md:text-lg text-md">
              Quick Links
            </h3>
        ...
        <span className="block border-gray-200 dark:border-gray-600 border-b-2 px-5 w-full mt-4"></span>
        <p className="pt-1 text-gray-900 dark:text-white text-sm ">
